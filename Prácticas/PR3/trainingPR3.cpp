...
// función que calcula la media de los elementos de una columna de la matriz
// devuelve la media calculada y dos enteros el número que son mayores 
// a la media y el número que son menores a la media
...
int main() {
  ...
  do {
    ...
    "(2) Calcular la media de columna\n"
    ...
    switch (opcion) {
      ...
      // Opción 2 ////////////////////////////////////////////////////////////
      case 2:
        // pide el número de columna a procesar usando la función leeColumna
        std::cout << "Indice de columna: ";
        int indCol;
        indCol = leeColumna(matTrabajo->nCol);
        if (indCol < 0) {
          break; // salimos del switch
        }
        // calcula la media de la columna usando la función calcula_media
        double media;
        int numMayor, numMenor;
        std::tie(media, numMayor, numMenor) = calcula_media(matTrabajo, indCol);
        std::cout << "Media de la columna " << indCol << ": " << media << "\n";
        std::cout << "Elementos mayores a la media: " << numMayor << "\n";
        std::cout << "Elementos menores a la media: " << numMenor << "\n";
        break; // salimos del switch
